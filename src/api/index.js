...
export const createMinistry  = (name, icon) => req('POST',   '/api/ministries',      { name, icon });
export const updateMinistry  = (id, name, icon) => req('PUT', `/api/ministries/${id}`, { name, icon });
...
export const addMember      = (id, ministryId, memberId) =>
  req('PATCH', `/api/rosters/${id}/add-member`,    { ministryId, memberId });
export const removeMember   = (id, ministryId, memberId) =>
  req('PATCH', `/api/rosters/${id}/remove-member`, { ministryId, memberId });
